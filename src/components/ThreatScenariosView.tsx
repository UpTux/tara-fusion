...
export const ThreatScenariosView: React.FC<ThreatScenariosViewProps> = ({ project, onUpdateProject, isReadOnly }) => {
  ...
  const riskLevel = useMemo(() => {
    if (!editorState || !derivedImpact || !feasibilityRating) return null;
    return calculateRiskLevel(feasibilityRating, derivedImpact);
  }, [editorState, derivedImpact, feasibilityRating]);
  ...
  }, [scenarios, project.damageScenarios]);
