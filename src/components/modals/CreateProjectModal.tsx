                ...
                <div className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            >
                                <div className="flex items-center justify-between mb-2">
                                    <span className="font-semibold text-vscode-text-bright">STRIDE + DREAD</span>
                                    {selectedMethodology === TaraMethodology.STRIDE && (
                                        <div className="w-3 h-3 rounded-full bg-vscode-accent"></div>
                                    )}
                                </div>
                                <p className="text-xs text-vscode-text-secondary">
                                    Microsoft's threat modeling with DREAD risk rating (Spoofing, Tampering, Repudiation, etc.).
                                </p>
                            </div>
