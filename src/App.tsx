...
import { AttackFeasibilityRating, Impact, ImpactCategorySettings, NeedStatus, NeedType, Organization, OrganizationRole, Project, ProjectMembership, ProjectStatus, RiskTreatmentDecision, SecurityProperty, User } from './types';
...
// Demo project data that can be imported by users
const demoProjectPhoenix: Omit<Project, 'id' | 'organizationId'> = {
